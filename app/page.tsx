...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      >
        <SplideSlide className="grid grid-cols-1 lg:grid-cols-2 items-stretch">
          <div className="max-w-[28rem] w-full md:ml-16 md:mb-16">
            ...
            <p className="font-serif text-[#6a6161] mb-10">
              ...
              <span className="italic">&#32; cashmere</span>, ethically sourced
